...
#include "scull_true-unreach-call.h"
...
unsigned_long copy_to_user(char to, char from, unsigned_long n) {
  to = from;
  return __nondet_int();
}

unsigned_long copy_from_user(char to, char from, unsigned_long n) {
  to = from;
  return __nondet_int();
}

int __get_user(int size, void_ptr ptr)
{
  return __nondet_int();
}

int __put_user(int size, void_ptr ptr)
{
    return __nondet_int();
} 
...
int scull_open(int tid, inode i, file filp) 
{
  scull_dev dev;
 ...
 * Follow the list
 */
scull_qset_type scull_follow(scull_dev dev, int n) {
  return __nondet_int();
}
...
ssize_t scull_read(int tid, file filp, char buf, size_t count, 
		   loff_t f_pos) 
{
  scull_dev dev = filp;
...
ssize_t scull_write(int tid, file filp, char buf, size_t count, 
		    loff_t f_pos) 
{
  scull_dev dev = filp;
...
int scull_ioctl(inode i, file filp,
...
loff_t scull_llseek(file filp, loff_t off, int whence, loff_t f_pos)
{
  scull_dev dev = filp;
  loff_t newpos;
